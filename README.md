...
- Copilot-related configs
  - Purpose: agentic coding config and instructions (see copilot/ directory), including default Caveman brevity mode and remote MCP servers such as Atlassian and Stripe.
